...
export default function PrivacyPage() {
  return <><SiteHeader /><main className="mx-auto w-full max-w-3xl flex-1 space-y-6 px-5 py-12 leading-7">
    ...
    <p>Pedidos de remoção são executados automaticamente após uma hora da confirmação do e-mail, quando o cadastro deixa de ser exibido no diretório. Pedidos de alteração confirmados são encaminhados por e-mail à equipe responsável. Um registro de bloqueio é mantido para impedir que importações futuras o publiquem novamente. Resultados e cópias em buscadores externos dependem da atualização desses serviços.</p>
