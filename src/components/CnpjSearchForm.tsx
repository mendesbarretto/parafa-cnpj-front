...
export function CnpjSearchForm() {
  return (
    <form action="/busca" className="flex w-full max-w-2xl flex-col gap-3 sm:flex-row">
      ...
      <input id="search" name="search" className="min-h-12 flex-1 rounded-xl border border-input bg-card px-4 text-card-foreground outline-none ring-ring placeholder:text-muted-foreground focus:ring-2" placeholder="CNPJ ou nome da empresa" />
